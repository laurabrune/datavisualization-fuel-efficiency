...
emission <- read_csv("ghg-emissions-by-sector.csv")
...
# recoding as mpg is an american unit and the report is for an international institution 
table(cars$mpg_hwy)
...
# emission data usa in long format 
...
ggplot(emission_usa, aes(x = Year, y = vals_new, colour = Sectors)) + 
  geom_line(size = 1) + 
